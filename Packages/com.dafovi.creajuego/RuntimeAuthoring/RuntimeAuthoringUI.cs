...
namespace CreaJuego.Web
{
    public sealed class RuntimeAuthoringUI:MonoBehaviour
    {
        ...
        [SerializeField] Text status,save;
        [SerializeField] Button newButton,saveButton,openButton,undoButton,redoButton,frameAllButton,frameSelectedButton,levelButton,duplicateButton,deleteButton,modeButton;
        [SerializeField] Toggle snap;
        RuntimeAuthoringController c;Font font;Action<GameItem> selectionChanged;bool worldSelected,listInitialized;string appearanceSearch="";ItemKind? searchKind;
        ...
        public bool HasPreparedLayout=>canvas!=null&&catalog!=null&&list!=null&&properties!=null&&status!=null&&modeButton!=null;
        ...
        public void Build()
        {
            canvas=New("CreaJuego Web UI",transform).AddComponent<Canvas>();canvas.renderMode=RenderMode.ScreenSpaceOverlay;var scaler=canvas.gameObject.AddComponent<CanvasScaler>();scaler.uiScaleMode=CanvasScaler.ScaleMode.ScaleWithScreenSize;scaler.referenceResolution=new Vector2(1280,720);canvas.gameObject.AddComponent<GraphicRaycaster>();
            ...
            newButton=ButtonAt(editTop,"Nuevo",new Vector2(205,10),null,new Vector2(75,40));saveButton=ButtonAt(editTop,"Guardar",new Vector2(285,10),null,new Vector2(82,40));openButton=ButtonAt(editTop,"Abrir",new Vector2(372,10),null,new Vector2(70,40));undoButton=ButtonAt(editTop,"↶",new Vector2(447,10),null,new Vector2(42,40));redoButton=ButtonAt(editTop,"↷",new Vector2(494,10),null,new Vector2(42,40));
            frameAllButton=ButtonAt(editTop,"Ver todo",new Vector2(545,10),null,new Vector2(90,40));frameSelectedButton=ButtonAt(editTop,"Encontrar",new Vector2(640,10),null,new Vector2(92,40));levelButton=ButtonAt(editTop,"Nivel",new Vector2(737,10),null,new Vector2(70,40));
            snap=ToggleAt(editTop,"Alinear automáticamente",new Vector2(817,10),null,new Vector2(235,40));save=Label(top,"",13,new Vector2(900,8),new Vector2(170,44));modeButton=ButtonAt(top,"JUGAR",new Vector2(1080,8),null,new Vector2(185,44));
            ...
            Label(left,"MI JUEGO",17,new Vector2(12,263),new Vector2(200,30));list=Scroll("Mi juego",left,new Vector2(10,48),new Vector2(210,215));duplicateButton=ButtonAt(left,"Duplicar",new Vector2(10,7),null,new Vector2(98,34));deleteButton=ButtonAt(left,"Eliminar",new Vector2(112,7),null,new Vector2(98,34));
        ...
        {
            Bind(newButton,()=>c.NewProject());Bind(saveButton,c.SaveNow);Bind(openButton,c.LoadLast);Bind(undoButton,c.Undo);Bind(redoButton,c.Redo);Bind(frameAllButton,c.FrameAll);Bind(frameSelectedButton,c.FrameSelected);
            Bind(levelButton,()=>{worldSelected=true;c.Selection.Clear();Refresh();});Bind(duplicateButton,c.DuplicateSelected);Bind(deleteButton,c.DeleteSelected);Bind(modeButton,c.ToggleMode);
