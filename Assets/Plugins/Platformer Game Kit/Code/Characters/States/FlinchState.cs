...
namespace PlatformerGameKit.Characters.States
{
    ...
    /// <see href="https://kybernetik.com.au/platformer/docs/characters/states/flinch">
    /// Flinch</see>
    /// </remarks>
    ...
    public class FlinchState : CharacterState
    {
        ...
        public override float MovementSpeedMultiplier
            ...
            ? _FlinchMovementSpeedMultiplier
            : 0;
        ...
        public override void OnEnterState()
        {
            ...
            var animation = Character.Health.CurrentHealth > 0
                ? _FlinchAnimation
                : _DieAnimation;
