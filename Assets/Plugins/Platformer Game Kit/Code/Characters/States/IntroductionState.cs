...
{
    /// <summary>
    /// A <see cref="CharacterState"/> that plays a <see cref="UnityEngine.Playables.PlayableAsset"/>
    /// (such as a <see cref="UnityEngine.Timeline.TimelineAsset"/>) then returns to idle.
    /// </summary>
    /// <remarks>
    /// <strong>Documentation:</strong>
    /// <see href="https://kybernetik.com.au/platformer/docs/characters/states/introduction">
    /// Introduction</see>
    /// </remarks>
    ...
    [PlatformerHelpUrl(typeof(IntroductionState))]
    public class IntroductionState : CharacterState
    {
        /************************************************************************************************************************/
