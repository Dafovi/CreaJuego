...
namespace PlatformerGameKit.Characters.States
{
    ...
    /// <see href="https://kybernetik.com.au/platformer/docs/characters/states/attack/advanced">
    /// Advanced Attack</see>
    /// </remarks>
    ...
    [PlatformerHelpUrl(typeof(AdvancedAttackState))]
    public class AdvancedAttackState : AttackState
    {
        /************************************************************************************************************************/
        ...
        private void OnAnimationEnd()
        {
            if (_Combo)
            {
                ...
                // Or if you want to allow infinite combos by looping back to the start of the sequence, replace that if with:
                // if (_CurrentIndex >= CurrentAnimations.Length)
                //     _CurrentIndex = 0;
                // PlayAnimation();
            }
