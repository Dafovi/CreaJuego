...
namespace PlatformerGameKit.Characters
{
    ...
    /// <see href="https://kybernetik.com.au/platformer/docs/characters/character">
    /// Character Component</see>
    /// </remarks>
    ...
    public class Character : MonoBehaviour
    {
        ...
        public CharacterAnimancerComponent Animancer
            => _Animancer;
        ...
        /// </code>
        /// This <see cref="Editor"/> class would also need to be removed.
        /// </example>
        ...
        public class Editor : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                target.MovementDirection = UnityEditor.EditorGUILayout.Vector2Field(
                    "Movement Direction",
                ...
                var state = UnityEditor.EditorGUILayout.ObjectField(
                    "Current State",
                    target.StateMachine.CurrentState,
