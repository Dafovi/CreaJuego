...
namespace PlatformerGameKit.Characters
{
    ...
    [PlatformerHelpUrl(typeof(BoxCharacterBody2D))]
    public class BoxCharacterBody2D : CharacterBody2D
    {
        /************************************************************************************************************************/
        ...
        /// <inheritdoc/>
        public override float StepHeight
            => _StepHeight;
        ...
        /// forth.
        /// </summary>
        public ref bool VerifyAvailableSpace
            => ref _VerifyAvailableSpace;
        ...
        public ref float DebugLineDuration
            => ref _DebugLineDuration;
#endif
        ...
        /// <inheritdoc/>
        public override PlatformContact2D GroundContact
            => _GroundContact;
        ...
        protected virtual void OnCollisionStay2D(Collision2D collision)
        {
            ...
            for (int i = 0; i < count; i++)
            {
...
#if UNITY_EDITOR && UNITY_PHYSICS_2D
                    PlatformerUtilities.DrawRay(
                        contact, new(0, 1, 0.5f), _DebugLineDuration);
#endif
                    return;
                }
#if UNITY_EDITOR && UNITY_PHYSICS_2D
                ...
                {
                    PlatformerUtilities.DrawRay(
                        contact, new(0, 0.75f, 0), _DebugLineDuration);
                }
#endif
            }
        }
        ...
        private bool TrySnapToGround()
        {
            ...
            PlatformerUtilities.DrawBoxCast(
                origin, castSize, Vector2.down * castDistance, new(0, 1, 0), _DebugLineDuration);
#endif
            ...
            var count = Physics2D.BoxCast(
                ...
                Vector2.down,
                _GroundFilter,
                PlatformerUtilities.OneRaycastHit,
                castDistance);
...
#if UNITY_EDITOR && UNITY_PHYSICS_2D
                PlatformerUtilities.DrawRay(
                    hit, new(0.375f, 0, 0), _DebugLineDuration);
#endif
            ...
            if (_VerifyAvailableSpace && velocity.x != 0)// If we aren't moving, we obviously already fit where we are standing.
            {
                ...
                if (Physics2D.OverlapBox(origin, castSize, Rotation, _GroundFilter.layerMask) != null)
                {
                    ...
                    PlatformerUtilities.DrawBox(
                        origin, castSize, new(0, 0, 0.375f), _DebugLineDuration);
#endif
...
#if UNITY_EDITOR && UNITY_PHYSICS_2D
                PlatformerUtilities.DrawRay(
                    hit, new(0, 1, 0), _DebugLineDuration);
                PlatformerUtilities.DrawLine(
                    position, origin, new(0, 1, 0), _DebugLineDuration);
            }
            else
            {
                PlatformerUtilities.DrawRay(
                    hit, new(0.25f, 0.5f, 0.5f), _DebugLineDuration);
#endif
            }
