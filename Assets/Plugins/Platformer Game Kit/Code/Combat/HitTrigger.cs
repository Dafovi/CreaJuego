...
namespace PlatformerGameKit
{
    ...
    public class HitTrigger : MonoBehaviour
    {
        ...
        /// <remarks>
        /// The prefab must be located in the root of a <see cref="Resources"/> folder and its name must be
        ...
        public static HitTrigger Activate(Character character, HitData data, bool flipX, HashSet<Hit.ITarget> ignore)
        {
            ...
            {
                var points = ListPool.Acquire<Vector2>();
