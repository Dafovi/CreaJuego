...
namespace PlatformerGameKit
{
    ...
    /// <see href="https://kybernetik.com.au/platformer/docs/combat/hits">
    /// Hits</see>
    /// </remarks>
    ...
    public partial struct Hit
    {
        ...
        public readonly void TryHitComponents(Component[] targets, bool dontHitAgain = true)
            => TryHitComponents(targets, targets.Length, dontHitAgain);

        /// <summary>Calls <see cref="TryHitComponent"/> on each of the `targets`.</summary>
        public readonly void TryHitComponents(Component[] targets, int count, bool dontHitAgain = true)
        {
